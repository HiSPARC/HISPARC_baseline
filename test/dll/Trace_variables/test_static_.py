...
trace = [200,200,200,100,150,180,200,200,200,200,200,200,100,150,180,200,200,200,200,200,100,150,180,200,200,200]
...
# Run the DLL
dll_return = trace_Variables(trace_array, 52, len(trace), 25, 200, byref(blah))
